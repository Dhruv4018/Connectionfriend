...
const Network = () => {
  ...
  return (
    <div className='w-screen h-[100vh] bg-[#f0efe7] pt-[100px] px-[20px] flex flex-col items-center gap-[40px]'>
      ...
      {connections.length >0 && <div className='w-[100%] max-w-[900px] shadow-lg flex flex-col gap-[20px] min-h-[100px] bg-gray-100'>
        {connections.map((connection, index) => (
          <div key={index} className='w-full min-h-[100px] flex justify-between items-center'>
            <div className='flex justify-center items-center gap-[10px]'>
              ...
              <img src={connection.sender.profileImage || logo2} alt="" className='w-full h-full' />
            </div>
            <div>
